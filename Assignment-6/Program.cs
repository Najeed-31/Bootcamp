...
*/
            ...
            builder.Services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("RequireDoctorOrAdmin", policy => policy.RequireRole("Doctor", "Administrator"));
                options.AddPolicy("RequireReceptionistOrAdmin", policy => policy.RequireRole("Receptionist", "Administrator"));
                options.AddPolicy("RequireAny", policy => policy.RequireRole("Administrator", "Doctor", "Receptionist", "Guest"));
            });
